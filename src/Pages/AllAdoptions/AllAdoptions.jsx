    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="flex justify-center mb-10">
        <input
          ...
          className="w-full max-w-md px-5 py-3 rounded-lg border border-[#840B36] focus:outline-none focus:ring-2 focus:ring-[#840B36] text-[#840B36] placeholder-[#BA6C7D]"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredPets?.map((pet) => (
          <div
            key={pet._id}
            className="bg-gradient-to-r from-[#FFD6BE] via-[#FFE8DA] to-[#FFD6BE] rounded-lg shadow-md overflow-hidden border border-gray-200 flex flex-col hover:shadow-xl transition"
          >
      ...
      {selectedPet && (
        ...
        >
          <div
            className="bg-gradient-to-r from-[#FFD6BE] via-[#FFE8DA] to-[#FFD6BE] rounded-lg shadow-lg p-10 w-full max-w-2xl h-[600px] text-[#840B36] relative overflow-y-auto"
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 mb-10 w-full h-auto ">
              ...
              <div>
                <Link
                  to={`/adopt/${selectedPet._id}`}
                  className="mt-4 inline-block bg-[#840B36] text-white px-4 py-2 rounded hover:bg-[#BA6C7D] transition"
                >
                  Adopt
                </Link>
              </div>
