...
const Banner = () => {
    return (
        <div className="hero min-h-screen bg-gradient-to-r from-[#FFE8DA] via-[#FFD6BE] to-[#FFE3D0]">
            ...
            <div className="bg-gradient-to-r from-[#FFE8DA] via-[#FFD6BE] to-[#FFE3D0] py-30 px-6 lg:px-20 flex flex-col-reverse lg:flex-row items-center justify-between">
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left animate-fade-in-up">
                    ...
                    <h1 className="text-3xl md:text-3xl font-bold text-[#99475C] leading-tight mb-4">
